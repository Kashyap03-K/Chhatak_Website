...
export default function CoastalStory({ fullscreen = false, scenes } = {}) {
  ...
  return (
    <section className={`coastal-story${fullscreen ? ' coastal-story--hero' : ''}`} ref={sectionRef} aria-label="The Chhatak journey">
      <svg width="0" height="0" style={{ position: 'absolute' }} aria-hidden="true">
        <defs>
          <filter id="storyCloudEdge" x="-10%" y="-10%" width="120%" height="120%">
            <feTurbulence type="fractalNoise" baseFrequency="0.013" numOctaves="3" seed="6" result="turb" />
      ...
      <div className="story-stage" onMouseEnter={() => setPaused(true)}>
        <div className="story-frame">
          ...
          <div className="story-clouds" aria-hidden="true" />
